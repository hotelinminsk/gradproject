...
import LocationPermissionSheet from "@/components/student/LocationPermissionSheet";
    ...
    <div className="min-h-screen bg-background pb-safe-nav">
      ...
      <div className="px-4 space-y-4">
        <LocationPermissionSheet
          open={showLocationSheet && locationPermission !== "granted"}
          onOpenChange={setShowLocationSheet}
          onAllow={() => {
            setShowLocationSheet(false);
            requestLocationPermission();
          }}
          onLater={() => setShowLocationSheet(false)}
        />
        {/* Location Status */}
        <Card className="p-4">
          ...
          {locationPermission === "granted" ? (
            ...
            <div className="text-center py-4">
              ...
              <Button onClick={requestLocationPermission} variant="default">
                Enable Location
              </Button>
            </div>
          )}
